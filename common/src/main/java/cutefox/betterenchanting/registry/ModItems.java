...
public class ModItems {
    ...
    public static void registerModItems(){
        BetterEnchanting.LOGGER.info("Registering mod items for : "+ BetterEnchanting.MOD_ID);
        ITEMS.register();
    }
    ...
    /*public static final RegistrySupplier<Item> SOUL_ESSENCE_1 = registerItem("soul_essence_1",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> SOUL_ESSENCE_2 = registerItem("soul_essence_2",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> SOUL_ESSENCE_3 = registerItem("soul_essence_3",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> ESSENCE_OF_SNEAK_1 = registerItem("essence_of_sneak_1",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> ESSENCE_OF_SNEAK_2 = registerItem("essence_of_sneak_2",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> ESSENCE_OF_SNEAK_3 = registerItem("essence_of_sneak_3",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> ESSENCE_OF_FEATHER = registerItem("essence_of_feather",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> ESSENCE_OF_RESPIRATION = registerItem("essence_of_respiration",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> ESSENCE_OF_SEA = registerItem("essence_of_sea",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> ESSENCE_OF_THORN = registerItem("essence_of_thorn",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> ESSENCE_OF_ICE = registerItem("essence_of_ice",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));

    //Swords
    public static final RegistrySupplier<Item> ESSENCE_OF_SWEEPING = registerItem("essence_of_sweeping",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> ESSENCE_OF_SHARPNESS = registerItem("essence_of_sharpness",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> ESSENCE_OF_SMITE = registerItem("essence_of_smite",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> ESSENCE_OF_ARTHROPODS = registerItem("essence_of_arthropods",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> ESSENCE_OF_KNOCKBACK = registerItem("essence_of_knockback",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> ESSENCE_OF_FIRE = registerItem("essence_of_fire",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> ESSENCE_OF_LOOTING = registerItem("essence_of_looting",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));

    //Bows
    public static final RegistrySupplier<Item> ESSENCE_OF_ARROWS = registerItem("essence_of_arrows",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> ESSENCE_OF_POWER = registerItem("essence_of_power",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> ESSENCE_OF_PUNCH = registerItem("essence_of_punch",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));

    //Tools
    public static final RegistrySupplier<Item> ESSENCE_OF_EFFICIENCY = registerItem("essence_of_efficiency",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> ESSENCE_OF_SILK_TOUCH = registerItem("essence_of_silk_touch",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> ESSENCE_OF_FORTUNE = registerItem("essence_of_fortune",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));

    //Fishing tool
    public static final RegistrySupplier<Item> ESSENCE_OF_SEA_LUCK = registerItem("essence_of_sea_luck",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> ESSENCE_OF_LURE = registerItem("essence_of_lure",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));

    //Anything
    public static final RegistrySupplier<Item> ESSENCE_OF_EXPERIENCE = registerItem("essence_of_experience",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> ESSENCE_OF_MENDING = registerItem("essence_of_mending",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> ESSENCE_OF_UNBREAKING = registerItem("essence_of_unbreaking",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));

    //Trident
    public static final RegistrySupplier<Item> ESSENCE_OF_CHANNELING = registerItem("essence_of_channeling",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> ESSENCE_OF_IMPALING = registerItem("essence_of_impaling",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> ESSENCE_OF_LOYALTY = registerItem("essence_of_loyalty",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> ESSENCE_OF_RIPTIDE = registerItem("essence_of_riptide",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));

    //Crossbow
    public static final RegistrySupplier<Item> ESSENCE_OF_MULTISHOT = registerItem("essence_of_multishot",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> ESSENCE_OF_PIERCING = registerItem("essence_of_piercing",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> ESSENCE_OF_QUICK_CHARGE = registerItem("essence_of_quick_charge",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));

    //Mace
    public static final RegistrySupplier<Item> ESSENCE_OF_DENSITY = registerItem("essence_of_density",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> ESSENCE_OF_BREACH = registerItem("essence_of_breach",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    public static final RegistrySupplier<Item> ESSENCE_OF_WIND = registerItem("essence_of_wind",  new Item(new Item.Settings().maxCount(1).fireproof().component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
    */
/*
    ...
    //endregion
*/
    private static RegistrySupplier<Item> registerItem(String id, Item item){
        MOD_ITEM_LIST.add(item);
