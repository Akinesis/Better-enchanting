...
public class ModTradeOffers extends TradeOffers {
    ...
    private static Factory createLibrarianTradeIngredientFactory(int experience) {
        return new cutefox.betterenchanting.registry.ModTradeOffers.betterEnchanting.TypedWrapperFactory(Map.of(
    ...
    private record betterEnchanting$TypedWrapperFactory(Map<VillagerType, Factory> typeToFactory) implements Factory {
        ...
        public static cutefox.betterenchanting.registry.ModTradeOffers.betterEnchanting.TypedWrapperFactory of(Factory factory, VillagerType... types) {
            return new cutefox.betterenchanting.registry.ModTradeOffers.betterEnchanting.TypedWrapperFactory((Map) Arrays.stream(types).collect(Collectors.toMap((type) -> {
                return type;
            }, (type) -> {
                return factory;
            })));
